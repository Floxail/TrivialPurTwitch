...
export const WelcomeContent = ({ showHelpHint = true }: { showHelpHint?: boolean }) => (
  <>
    ...
    <ul style={{ lineHeight: '1.8', fontSize: '0.95rem' }}>
      ...
      <li>
        ...
        Le <strong>contenu de ta sélection</strong> (nombre de questions, QCM / Libre) ainsi qu'une description de la boite s'affiche juste sous le bouton <em>Lancer un Quiz</em>.
      </li>
      <li>
      ...
      {showHelpHint && (
        <li>
          <FontAwesomeIcon icon={['fas', 'question-circle']} className="me-2" style={{ color: 'var(--lumon-cyan)' }} />
          Plus d'infos sur le <strong>scoring</strong> et le détail pour <strong>proposer des questions</strong> dans le <strong>Help</strong> (menu en haut à droite).
        </li>
      )}
    </ul>
  </>
